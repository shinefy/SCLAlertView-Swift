...
public class SCLButton: UIButton {
    open  var actionType = SCLActionType.none
    ...
    open  var showDurationStatus:Bool=false
...
open class SCLAlertView: UIViewController {
    ...
    open func buttonTapped(_ btn:SCLButton) {
    ...
    open func buttonTapDown(_ btn:SCLButton) {
        var hue : CGFloat = 0
    ...
    open func buttonRelease(_ btn:SCLButton) {
